...
int kontrol(float min, float maks)
{
	...
	do
	{
		if (!(notu >= min and notu <= maks))
		{
			...
			cout << "Lütfen Tekrar Deðer Giriniz: ";
			cin >> notu;
			cout << endl;
		}
...
void aralýk(float alt, float üst, float notdizi, string addizi, string soyaddizi, string harf)
{
	static int i = 0;
...
int main()
{
	...
	do
	{
		...
		case 2:
			...
			cout << "Kaç Adet Öðrenci Bilgisi Girmek Ýstersiniz? (En fazla 100 öðrenci)" << endl;
			...
			for (int i = 0; i < ögrenciSayisi; i++)
			{
				...
				cout << i + 1 << ". Öðrencinin Doðum Tarihini Giriniz: " << endl;
				cout << "GÜN: ";
